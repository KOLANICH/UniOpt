...
from lazily.btb.hyper_parameter import HyperParameter, IntHyperParameter, FloatHyperParameter, CatHyperParameter, ParamTypes
from lazily.btb.tuning import GP, GPEi, GPEiVelocity, GCP, GCPEi, GCPEiVelocity


class BayTuneSpec(MSpec(scalarMode=ScalarMetaMap.degenerateCategory)):
	class HyperparamsSpecsConverters:
		randint = lambda k, dist, tp: IntHyperParameter(ParamTypes.INT, dist.a, dist.b)
		...
		_categorical = lambda k, categories: CatHyperParameter(ParamTypes.INT_CAT, categories)
