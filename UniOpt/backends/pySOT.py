...
from lazily.poap.controller import ThreadController, BasicWorkerThread, EvalRecord
from lazily.pySOT.experimental_design import SymmetricLatinHypercube
from lazily.pySOT.strategy import SRBFStrategy
from lazily.pySOT.surrogate import RBFInterpolant, CubicKernel, LinearTail, SurrogateUnitBox
...
class PySOTSpec(ArraySpecOnlyBoxes):
	...
	class HyperparamsSpecsConverters:
		uniform = lambda k, dist, tp: (tp, dist.ppf(0), dist.ppf(1))
